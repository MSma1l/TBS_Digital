...
**1,116 tests across 63 files** (the Phase 0 gate of the IT-OS HUD foundation, 2026-09-17; the
result of each full run is recorded in [`CHANGELOG.md`](../CHANGELOG.md), and the per-file counts
below are from that run). Before the HUD foundation it was 1,031 across 57; before the interior
redesign, 566 across 36; before the HUD redesign, 316 across 21.
